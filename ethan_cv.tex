...
\section{Experience}
    ...
    \smallskip
     \coloredbullet\ %
     Consulted on the development of a web application for Egoscue pain management, enhancing efficacy and expanding the client base through generative routine planning and digital coaching.
     
     \smallskip
     \coloredbullet\ %
     Planned and developed automation services for a marketing agency that increased output by 5x. Services included social platform schedulers, analytics, web scraping, and streamlined hiring processes.
     \smallskip
     }
     %
