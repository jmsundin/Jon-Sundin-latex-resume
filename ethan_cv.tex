...
\section{Experience}
    ...
    \smallskip
     \coloredbullet\ %
     Consulted on and developed a web application for Egoscue pain management using Next.js, Firebase, and Tailwind CSS.
     
     \smallskip
     \coloredbullet\ %
     Planned and developed automation services for a marketing agency, including social platform schedulers, analytics, web scraping, and hiring processes.
